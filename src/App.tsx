...
import Cardo4 from "./components/Cardo4";
import Cardo5 from "./components/Cardo5";
import Cardo6 from "./components/Cardo6";
import Cardo7 from "./components/Cardo7";
...
import Cardo12 from "./components/Cardo12";
import Cardo13 from "./components/Cardo13";
import Cardo14 from "./components/Cardo14";
import Cardo15 from "./components/Cardo15";
import Cardo16 from "./components/Cardo16";
import Cardo17 from "./components/Cardo17";
import Cardo18 from "./components/Cardo18";
import Cardo19 from "./components/Cardo19";
import Cardo20 from "./components/Cardo20";
    ...
    <div className="flex flex-col min-h-screen">
      ...
      <main className="flex-grow">
        <Routes>
          ...
          <Route path="/cardo4" element={<Cardo4/>} />
          <Route path="/cardo5" element={<Cardo5/>} />
          <Route path="/cardo6" element={<Cardo6/>} />
          <Route path="/cardo7" element={<Cardo7/>} />
          ...
          <Route path="/cardo12" element={<Cardo12/>} />
          <Route path="/cardo13" element={<Cardo13/>} />
          <Route path="/cardo14" element={<Cardo14/>} />
          <Route path="/cardo15" element={<Cardo15/>} />
          <Route path="/cardo16" element={<Cardo16/>} />
          <Route path="/cardo17" element={<Cardo17/>} />
          <Route path="/cardo18" element={<Cardo18/>} />
          <Route path="/cardo19" element={<Cardo19/>} />
          <Route path="/cardo20" element={<Cardo20/>} />
        </Routes>
      </main>
