        ...
        <div className="flex flex-col lg:flex-row gap-12 lg:gap-20">
          ...
          <div className="lg:w-5/12">
             <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <div className="bg-white border border-gray-100 p-6 rounded-[24px] shadow-sm hover:shadow-md transition-shadow">
                   <p className="text-gray-400 text-[12px] uppercase font-bold mb-2">Մինչև</p>
                   <p className="text-[#6c2db5] text-[28px] font-black">6 մուտք</p>
                ...
                <div className="bg-white border border-gray-100 p-6 rounded-[24px] shadow-sm hover:shadow-md transition-shadow">
                   ...
                   <p className="text-[#6c2db5] text-[28px] font-black">6 անգամ</p>
                ...
                <div className="bg-[#6c2db5] p-6 rounded-[24px] text-white mt-5"> 
                   <p className="text-white text-[28px] font-black">16․000֏</p>
