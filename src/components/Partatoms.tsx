      ...
      content: (
        <div className="flex flex-col gap-6">
          ...
          <div>
            ...
            <p className="text-gray-700 text-[14px] leading-relaxed">
              Դուք կարող եք ձեռք բերել պարտատոմսեր ինչպես բանկի մասնաճյուղերում, այնպես էլ EvocaTOUCH հավելվածի միջոցով՝ արագ և հարմարավետ:
            </p>
          </div>
        </div>
      )
  ...
  return (
    <div className="w-full bg-white font-sans">
      ...
      <div className="max-w-[1400px] mx-auto px-6 pb-20">
        ...
        <div className="mb-12">
          <h2 className="text-[20px] font-bold text-[#1f0b40] uppercase mb-6">Ընթացիկ թողարկում</h2>
          <div className="overflow-x-auto border border-gray-200 rounded-xl">
            <table className="w-full text-left border-collapse">
              <thead>
                <tr className="bg-[#f8f9fa]">
                  <th className="p-4 border-b font-bold text-[#6c2db5]">Դաս</th>
                  <th className="p-4 border-b font-bold text-[#6c2db5]">Անվանական արժեկտրոնային</th>
                  <th className="p-4 border-b font-bold text-[#6c2db5]">Անվանական արժեկտրոնային</th>
                </tr>
              </thead>
              <tbody>
                <tr>
                  <td className="p-4 border-b text-gray-700">Անվանական արժեք</td>
                  <td className="p-4 border-b text-gray-700">10,000 ՀՀ դրամ</td>
                  <td className="p-4 border-b text-gray-700">100 ԱՄՆ դոլար</td>
                </tr>
                <tr>
                  <td className="p-4 border-b text-gray-700">Արժեկտրոնային տարեկան տոկոսադրույք</td>
                  <td className="p-4 border-b text-gray-700">10%</td>
                  <td className="p-4 border-b text-gray-700">5.25%</td>
                </tr>
                <tr>
                  <td className="p-4 border-b text-gray-700">Շրջանառության ժամկետ</td>
                  <td className="p-4 border-b text-gray-700">24 ամիս</td>
                  <td className="p-4 border-b text-gray-700">24 ամիս</td>
                </tr>
                <tr>
                  <td className="p-4 border-b text-gray-700">Արժեկտրոնների վճարման պարբերականություն</td>
                  <td className="p-4 border-b text-gray-700">Եռամսյակային</td>
                  <td className="p-4 border-b text-gray-700">Եռամսյակային</td>
                </tr>
              </tbody>
            </table>
        ...
        <div>
          <h2 className="text-[20px] font-bold text-[#1f0b40] uppercase mb-6">ԱՆՀՐԱԺԵՇՏ ՏԵՂԵԿԱՏՎՈՒԹՅՈՒՆ</h2>
          <div className="border-t border-gray-200">
            {accordions.map((acc, index) => (
              <div key={index} className="border-b border-gray-200">
                ...
                >
                  <span className={`text-[17px] font-bold uppercase ${openSection === acc.title ? 'text-[#6c2db5]' : 'text-[#333333] group-hover:text-[#6c2db5]'}`}>
                    {acc.title}
                  </span>
        ...
        <div className="max-w-[1400px] mx-auto px-6 mt-12 flex flex-col gap-3">
            ...
            >
                ...
                <span className="text-[16px] font-bold text-[#222] tracking-tight">Դոլարային պարտատոմսերիի գները 30.09.2024-29.11.2024 ժամանակահատվածի համար</span>
            </a>
            ...
            >
                ...
                <span className="text-[16px] font-bold text-[#222] tracking-tight">Դրամային պարտատոմսերիի գները 30.09.2024-29.11.2024 ժամանակահատվածի համար</span>
            </a>
        </div>
