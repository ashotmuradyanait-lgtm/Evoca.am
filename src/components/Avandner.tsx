  ...
  return (
    <div className="w-full bg-white">
      ...
      <div className="max-w-[1400px] mx-auto px-6 mb-10">
        <h1 className="text-[48px] font-bold text-[#1a1a1a]">Ավանդներ</h1>
      </div>
          ...
          <div>
            ...
            <div className="flex gap-12">
              ...
              <div className="flex flex-col border-l border-gray-100 pl-8 mt-5"> 
                <span className="text-[#6c2db5] text-[24px] font-bold">31-1,825 օր</span>
              ...
              <div className="flex flex-col border-l border-gray-100 pl-8 max-w-[180px]">
                <span className="text-gray-400 text-[12px] mt-1 italic">սկսած</span>
                <span className="text-[#6c2db5] text-[24px] font-bold">100,000 ֏</span>
                <span className="text-gray-400 text-[12px] mt-1 italic"> Համալրման հնարավորություն</span>
              </div>
            </div>
          </div>
      ...
      <div className="flex bg-white rounded-[20px] shadow-sm overflow-hidden border border-gray-100 p-6 gap-8 hover:shadow-md transition-shadow">
        ...
        <div className="flex flex-col justify-between flex-grow py-2">
          <div>
            ...
            <p className="text-gray-600 text-[15px] leading-relaxed max-w-[800px] mb-8">
                Ձեր երեխայի անհոգ ապագայի համար առաջարկում ենք ներդնել «Մանկական» ավանդ: «Մանկական» <br />
                ժամկետային ավանդն ընդունում ենք ֆիզիկական անձանցից` երեխաների անունով ներդնելու պայմանով:          
            </p>
            ...
            <div className="flex gap-12">
              ...
              <div className="flex flex-col border-l border-gray-100 pl-8"> 
                <span className="text-gray-400 text-[12px] mb-1">մինչև</span>
                <span className="text-[#6c2db5] text-[24px] font-bold">18 լրանալը</span>
                <span className="text-gray-400 text-[12px] mt-1">Ժամկետ</span>
              </div>
              ...
              <div className="flex flex-col border-l border-gray-100 pl-8 max-w-[180px]">
                <span className="text-gray-400 text-[12px] mt-1 italic">սկսած</span>
                <span className="text-[#6c2db5] text-[24px] font-bold">40,000 ֏</span>
                <span className="text-gray-400 text-[12px] mt-1 italic"> Համալրման հնարավորություն</span>
              </div>
            </div>
          </div>
      ...
      <div className="flex bg-white rounded-[20px] shadow-sm overflow-hidden border border-gray-100 p-6 gap-8 hover:shadow-md transition-shadow">
        ...
        <div className="flex flex-col justify-between flex-grow py-2">
          <div>
            ...
            <p className="text-gray-600 text-[15px] leading-relaxed max-w-[800px] mb-8">
                Ցանկանու՞մ եք ներդնել ավանդ բարձր տոկոսադրույքով, բայց չունե՞ք ժամանակ: Ձևակերպե՛ք <br />
                 EvocaONLINE ավանդ՝ առանց բանկ այցելելու: Իսկ մենք բոլոր փաստաթղթերը կուղարկենք Ձեր էլ. <br />
                  հասցեին:         
            </p>
            ...
            <div className="flex gap-12">
              ...
              <div className="flex flex-col border-l border-gray-100 pl-8">
                <span className="text-gray-400 text-[12px] mt-1 italic">մինչև</span>
                <span className="text-[#6c2db5] text-[24px] font-bold">10.75% ֏</span>
                <span className="text-gray-400 text-[12px] mt-1">Տոկոսադրույք</span>
              </div>
            </div>
          </div>
