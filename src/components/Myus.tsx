        ...
        <div className="flex flex-col lg:flex-row gap-8 lg:gap-16 items-center">
          <div className="flex-1">
            ...
            <p className="text-gray-600 text-[16px] md:text-[18px] leading-relaxed max-w-[600px]">
              Ցանկանո՞ւմ ես վերանորոգել բնակարանդ կամ պլանավորու՞մ ես գնել նոր կահույք։ Evoca-ի կողմից առաջարկվող նոր օվերդրաֆտի միջոցով դու կստեղծես քո երազանքների բնակարանը՝ ամենահարմար պայմաններով։
            </p>
          </div>
          ...
          <div className="lg:w-5/12">
             <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <div className="bg-white border border-gray-100 p-6 rounded-[24px] shadow-sm hover:shadow-md transition-shadow">
                   ...
                   <p className="text-[#6c2db5] text-[28px] font-black">300,000 ֏</p>
                   <p className="text-gray-800 font-bold mt-2">Գումար</p>
                </div>

                <div className="bg-white border border-gray-100 p-6 rounded-[24px] shadow-sm hover:shadow-md transition-shadow">
                   <p className="text-gray-400 text-[12px] uppercase font-bold mb-2">Մինչև</p>
                   <p className="text-[#6c2db5] text-[28px] font-black">36 ամիս</p>
                   <p className="text-gray-800 font-bold mt-2">Ժամկետ</p>
                </div>

                <div className="bg-white border border-gray-100 p-6 rounded-[24px] shadow-sm hover:shadow-md transition-shadow">
                   <p className="text-gray-400 text-[12px] uppercase font-bold mb-2">Սկսած</p>
                   <p className="text-[#6c2db5] text-[28px] font-black">16%</p>
                   <p className="text-gray-800 font-bold mt-2">Տոկոսադրույքից</p>
                </div>

                <div className="bg-[#6c2db5] p-6 rounded-[24px] text-white">
                   <p className="text-white/70 text-[12px] uppercase font-bold mb-2">Պետության կողմից</p>
                   <p className="text-white text-[28px] font-black">16%</p>
                   <p className="text-white font-bold mt-2 leading-tight">սուբսիդավորվող տոկոսադրույք</p>
                </div>
