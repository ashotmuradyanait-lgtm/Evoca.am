...
const Erkus: React.FC = () => {
  ...
  const categories = [
   ...
   const newsItems = [
    {
      img: "https://www.evoca.am/images-cache/blogs/1/17138737784517/510x383.jpg",
      title: "Ներդրումների կարելիներն ու չի կարելիները",
      date: "23.04.2024"
    },
    {
      img: "https://www.evoca.am/images-cache/blogs/1/17128187874533/510x383.jpg",
    ...
    <div className="w-full bg-white font-sans text-[#1a1a1a] overflow-x-hidden mt-20">
      ...
      <div className="max-w-[1400px] mx-auto px-4 sm:px-6 md:px-10">
        ...
        <div className="flex flex-wrap items-center gap-2 md:gap-4 text-gray-500 font-bold text-[14px] md:text-[15px] pb-10 md:pb-20">
           <Link to="/nerdrum" className="hover:text-black cursor-pointer transition-colors px-1">1</Link>
