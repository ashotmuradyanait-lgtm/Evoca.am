  ...
  return (
    <div className="min-h-screen bg-white font-sans text-gray-900 pb-20 relative overflow-hidden">
      ...
      <div className="absolute top-0 left-0 w-full h-[500px] z-0 overflow-hidden opacity-20">
        ...
        >
          <source src="https://www.evoca.am/static/v/digital-card.mp4" type="video/mp4" />
        </video>
      ...
      <div className="relative z-10">
        ...
        <div className="max-w-7xl mx-auto px-8 mt-6">
          <div className="max-w-[1400px] mx-auto px-6 py-6 flex items-center gap-2 text-gray-400 text-[13px]">
            ...
            <span className="cursor-pointer hover:text-gray-600">Քարտեր</span>
            <span>›</span>
            <span className="text-gray-800">Թվային քարտեր</span>
          </div>

          <h1 className="text-4xl font-extrabold mb-10 text-[#222]">Թվային քարտեր</h1>
