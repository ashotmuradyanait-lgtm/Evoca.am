...
const Card: React.FC = () => {
  ...
  const allCards: CardType[] = [
    ...
    { id: 2, name: 'Evoca Gift Card', text: '', desc: 'Evoca Gift Card-ը երբեք չի հիասթափեցնի. այն իդեալական նվեր է: Գնիր Evoca Gift Card, և լավագույն նվերը կլինի քոնը:', img: 'https://www.evoca.am/images-cache/cards/1/17149864970842/415x261.png' },
    ...
    { id: 5, name: 'Visa Vision', text: 'Evocabank-ը ներկայացնում է իր նոր՝ Visa Vision քարտը', desc: '0% կանխիկացում Evoca-ի բոլոր բանկոմատներից...', img: 'https://www.evoca.am/images-cache/cards/1/1714986482757/415x261.png' },
    { id: 6, name: 'Mastercard World Digital', text: '', desc: 'Պատվիրիր թվային քարտը հիմա...', img: 'https://www.evoca.am/images-cache/cards/1/17639683196125/415x261.png' },
    ...
    { id: 12, name: 'Mastercard Gold', text: '', desc: 'Քարտը կընդգծի քո կարգավիճակը...', img: 'https://www.evoca.am/images-cache/cards/1/17149865321136/415x261.png' },
    { id: 13, name: 'Mastercard Standard', text: '', desc: 'Ամենօրյա գնումներից մինչև անմոռանալի ճանապարհորդություն...', img: 'https://www.evoca.am/images-cache/cards/1/17149866652788/415x261.png' },
    { id: 14, name: 'Visa Digital', text: '', desc: '', img: 'https://www.evoca.am/images-cache/cards/1/17485025148319/415x261.png' },
    { id: 15, name: 'Visa Classic', text: '', desc: 'Ունիվերսալ վճարային քարտ...', img: 'https://www.evoca.am/images-cache/cards/1/1714986642953/415x261.png' },
    { id: 16, name: 'Arca Classic', text: '', desc: 'Ձեռք բեր ArCa Classic քարտը...', img: 'https://www.evoca.am/images-cache/cards/1/17404717644263/415x261.png' },
    { id: 17, name: 'Visa Business', desc: 'Մեկնեք գործուղման Evocabank-ի Visa Business քարտով...', text: 'Ձեր կազմակերպության դրամական միջոցները...', img: 'https://www.evoca.am/images-cache/cards/1/17149865475676/415x261.png' },
    { id: 18, name: "Dalma Gift Card", text: '', desc: 'Նվեր ընտրելն այլևս դժվար չէ...', img: 'https://www.evoca.am/images-cache/cards/1/17404717113297/415x261.png' },
    { id: 19, name: 'Rio Gift Card', text: '', desc: 'Մեզ հետ դու կարող ես խնայել ամենաթանկը...', img: 'https://www.evoca.am/images-cache/cards/1/17404717289057/415x261.png' },
    { id: 20, name: "Garage Masters' Mall Gift Card", text: '', desc: 'Evocabank-ը ներկայացնում է իր նոր Garage Masters Mall Gift Card-ը...', img: 'https://www.evoca.am/images-cache/cards/1/17404717481136/415x261.png' },
    { id: 21, name: 'Visa Gold', text: '', desc: 'Քարտն ապահովում է Ձեր հարմարավետությունը...', img: 'https://www.evoca.am/images-cache/cards/1/17149865646885/415x261.png' },
  ];
  ...
  return (
    <div className="min-h-screen w-full bg-[#f4f7f9] font-['Inter',_sans-serif] flex items-center justify-center p-4 lg:p-10 overflow-hidden relative">
      <FontLink />
      
    
      <div className="absolute top-0 left-0 w-full h-full pointer-events-none overflow-hidden opacity-20">
          <div className="absolute top-[-10%] left-[-10%] w-[40%] h-[40%] bg-[#6C2AF5] rounded-full blur-[120px]" />
          <div className="absolute bottom-[-10%] right-[-10%] w-[40%] h-[40%] bg-[#553081] rounded-full blur-[120px]" />
      </div>

      <div className="w-full max-w-[1300px] flex flex-col lg:flex-row items-center gap-10 lg:gap-16 z-10">
        ...
        >
          <AnimatePresence mode="wait">
            ...
            >
              ...
              <div className="absolute inset-0 rounded-[35px] bg-gradient-to-tr from-white/10 to-transparent opacity-0 group-hover:opacity-100 transition-opacity pointer-events-none" />
            </motion.div>
          </AnimatePresence>
        </div>
        ...
        <div className="w-full lg:w-[350px] order-3">
          <AnimatePresence mode="wait">
            ...
            >
              <div className="mb-4">
                  <div className="w-8 h-1 bg-[#6C2AF5] rounded-full mb-4" />
              </div>
              ...
              <div className="flex flex-col gap-4">
                  ...
                  <div className="flex items-center gap-2 text-[13px] text-gray-400 font-semibold px-2">
